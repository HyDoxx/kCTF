...
class kCTF_AES {
	...
	uint8_t defaultInverseSbox[256] =
	{
...
public:
	...
	void setSbox(uint8_t *sbox) {
		this->sbox = sbox;
		this->inverseSbox = calcInverseSbox(sbox, this->sboxBuf);
	}
	void setSbox(uint8_t *sbox, uint8_t *inverseSbox) {
		this->sbox = sbox;
